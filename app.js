...
headDropdown.addEventListener('change', (e) => {
    ...
    headEl.style.backgroundImage = `url('./assets/${value}.png')`;
...
middleDropdown.addEventListener('change', (e) => {
    ...
    middleEl.style.backgroundImage = `url('./assets/${value}.png')`;
...
bottomDropdown.addEventListener('change', (e) => {
    ...
    bottomEl.style.backgroundImage = `url('./assets/${value}.png')`;
    // update the stats to show the new count (call displayStats() to do this work)
    displayStats();
});
